# Test: Verify that checkout displays error when required fields are missing

## Objective
To verify that the system prevents checkout progression and displays an appropriate error message when mandatory checkout information is not provided.

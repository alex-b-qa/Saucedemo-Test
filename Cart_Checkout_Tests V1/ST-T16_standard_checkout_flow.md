# Test: Successful checkout with valid information
...
## Objective
Verify if user can complete a full check out from cart to order with valid checkout details
...
- Step 2: First name, last name, and zip code display in their respective fields
